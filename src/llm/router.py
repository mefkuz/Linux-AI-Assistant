...
class Router:
    DEFAULT_SYSTEM_PROMPT = (
        ...
        "İNTERNET: Güncel bilgi gerektiren sorularda (güncel olaylar, sürümler, wikiler, hata çözümleri) `web_search` + `fetch_web_page` araçlarını kullan. Shell/curl/python ile web kazıma YASAK.\n\n"
